...
export const CodeExporterProvider = ({ children }) => {
     ...
     */
    const [isCodeExporterOpen, setIsCodeExporterOpen] = useState(getCodeExporterDefaultOpenState());
    ...
    const updateCodeExporter = (newState) => {
        ...
        console.log( { updateCodeExporter: {
                queryParams,
                newQueryParams
            }})
     ...
     */
    const value = hooks.applyFilters("graphiql_code_exporter_context_default_value", {
        isCodeExporterOpen,
        toggleCodeExporter,
    });
